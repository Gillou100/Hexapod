/* Auto-generated by genmsg_cpp for file /home/antoine/Stacks/Packages/Hexapod_Bringup/msg/Move.msg */
#ifndef HEXAPOD_BRINGUP_MESSAGE_MOVE_H
#define HEXAPOD_BRINGUP_MESSAGE_MOVE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Move_ {
  ...
  typedef boost::shared_ptr< ::Hexapod_Bringup::Move_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::Hexapod_Bringup::Move_<ContainerAllocator>  const> ConstPtr;
}; // struct Move
typedef  ::Hexapod_Bringup::Move_<std::allocator<void> > Move;

typedef boost::shared_ptr< ::Hexapod_Bringup::Move> MovePtr;
typedef boost::shared_ptr< ::Hexapod_Bringup::Move const> MoveConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::Hexapod_Bringup::Move_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::Hexapod_Bringup::Move_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::Hexapod_Bringup::Move_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::Hexapod_Bringup::Move_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::Hexapod_Bringup::Move_<ContainerAllocator> > {
  static const char* value() 
  {
    return "19d73750726e9d8d4d9709a3c0f3591d";
  }

  static const char* value(const  ::Hexapod_Bringup::Move_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x19d73750726e9d8dULL;
  static const uint64_t static_value2 = 0x4d9709a3c0f3591dULL;
};

template<class ContainerAllocator>
struct DataType< ::Hexapod_Bringup::Move_<ContainerAllocator> > {
  static const char* value() 
  {
    return "Hexapod_Bringup/Move";
  }
...
template<class ContainerAllocator>
struct Definition< ::Hexapod_Bringup::Move_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::Hexapod_Bringup::Move_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::Hexapod_Bringup::Move_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::Hexapod_Bringup::Move_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::Hexapod_Bringup::Move_<ContainerAllocator> & v) 
  {
...
#endif // HEXAPOD_BRINGUP_MESSAGE_MOVE_H
