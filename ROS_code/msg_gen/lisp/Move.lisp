...
(cl:defmethod cl:initialize-instance :after ((m <Move>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Hexapod_Bringup-msg:<Move> is deprecated: use Hexapod_Bringup-msg:Move instead.")))

(cl:ensure-generic-function 'header_byte-val :lambda-list '(m))
(cl:defmethod header_byte-val ((m <Move>))
...
(cl:defmethod right_vertical_joy_byte-val ((m <Move>))
...
(cl:defmethod right_horizontal_joy_byte-val ((m <Move>))
...
(cl:defmethod left_vertical_joy_byte-val ((m <Move>))
...
(cl:defmethod left_horizontal_joy_byte-val ((m <Move>))
...
(cl:defmethod button_byte-val ((m <Move>))
...
(cl:defmethod end_byte-val ((m <Move>))
...
(cl:defmethod checksum_byte-val ((m <Move>))
